...
$UNI_NAME_CLEAN = 'Osteopathieschule Deutschland GmbH';                           //the clean-name of your master-faculty (e.g. University of Göttingen), without html-entities (used for mail-system)
$STUDIP_INSTALLATION_ID='OSD_BETA';      //unique identifier for installation
$AUTH_LIFETIME = 300;                                    //the length of a session in minutes, zero means unlimited lifetime
...
$DB_STUDIP_HOST = "dd12400.kasserver.com";
$DB_STUDIP_USER = "d0176388";
$DB_STUDIP_PASSWORD = "7BeFhwTDqbKRWorp";
$DB_STUDIP_DATABASE = "d0176388";
...
$TMP_PATH ="/www/htdocs/w00caf39/studip/tmp";                                  //the system temp path                                //the system temp path

//paths to the command line tools, used in Stud.IP
$ZIP_USE_INTERNAL = TRUE;                              //set to true, if command-line zip/unzip is not available
...
$CHAT_SERVER_NAME = "ChatMysqlServer";
...
$STUDIP_API_KEY=''; // webservice api key
...
$LATEXRENDER_ENABLE = FALSE;     //enable to use the LaTexrenderer (Please note the further LaTeX template-settings below)
